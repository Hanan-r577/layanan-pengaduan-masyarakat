        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebar nav">
                ...
                <li class="sidebar-item {{ Request::is('users*') ? 'selected' : '' }}">
                    <a class="sidebar-link {{ Request::is('users*') ? 'active' : '' }}" href="{{ route('user.index') }}"
                        aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item {{ Request::is('status*') ? 'selected' : '' }}">
                    <a class="sidebar-link {{ Request::is('status*') ? 'active' : '' }}"
                        href="{{ route('statusPengaduan.index') }}" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item {{ Request::is('pengaduan*') ? 'selected' : '' }}">
                    <a class="sidebar-link {{ Request::is('pengaduan*') ? 'active' : '' }}"
                ...
                <li class="sidebar-item {{ Request::is('tanggapan*') ? 'selected' : '' }}">
                    <a class="sidebar-link {{ Request::is('tanggapan*') ? 'active' : '' }}"
                        href="{{ route('tanggapan.index') }}" aria-expanded="false">
                        <span>
